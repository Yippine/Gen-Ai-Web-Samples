...
// 設定 INI 文件路徑
const configDir = path.join(process.env.APPDATA || process.env.HOME, ".gpt-atm-demo");
...
app.post("/api/settings", (req, res) => {
    try {
        ...
        const config = ini.parse(fs.existsSync(iniPath) ? fs.readFileSync(iniPath, "utf-8") : "");
        config.username = username;
        config.userIcon = userIcon;
